...
<nav id="navmenu" class="navmenu">
        ...
        <li><a href="<?= isset($_SESSION['sudah_login']) ? 'appointment.php' : 'login.php'; ?>"> Appointment</a></li>
            <li class="dropdown"><a href="#"><span>More Pages</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
                ...
                <li><a href="404.php" class="active">404</a></li>
              </ul>
            </li>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="error-actions" data-aos="fade-up" data-aos-delay="500">
              <a href="404.php" class="btn-primary">
